                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final topSoldProducts = [
                          {'title': 'Snake Plant', 'price': 'Rs800', 'category': 'Indoor', 'image': 'assets/images/snake.jpg'},
                          {'title': 'Rose', 'price': 'Rs500', 'category': 'Outdoor', 'image': 'assets/images/rose.jpg'},
                          {'title': 'Bay Leaf', 'price': 'Rs700', 'category': 'Fruits & Herbs', 'image': 'assets/images/bayleaf.jpg'},
                          {'title': 'Marigold', 'price': 'Rs200', 'category': 'Seasonal', 'image': 'assets/images/marigold.jpg'},
                        ];
                        return ProductCard(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final recentArrivalsProducts = [
                          {'title': 'Peace Lily', 'price': 'Rs1200', 'category': 'Indoor', 'image': 'assets/images/peacelily.jpg'},
                          {'title': 'Jasmine', 'price': 'Rs600', 'category': 'Outdoor', 'image': 'assets/images/jasmine.jpg'},
                          {'title': 'Lemon Plant', 'price': 'Rs1200', 'category': 'Fruits & Herbs', 'image': 'assets/images/lemon.jpg'},
                          {'title': 'Lotus', 'price': 'Rs1000', 'category': 'Seasonal', 'image': 'assets/images/lily.jpg'},
                        ];
                        return ProductCard(
